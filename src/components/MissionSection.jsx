        ...
        <div className={styles.missionSection}>
            <div className={styles.container}>
                ...
                <p className={styles.purpose}>
                    <span className={styles.purposeIntro}>Our purpose is to</span> <br />
                    <span className={styles.purposeHighlight}>make parents lives</span>{" "}
                    <span className={styles.purposeEasier}>easier</span>
                    <span className={styles.purposeComma}>,</span> happier
                    <span className={styles.purposeComma}>,</span>
                    <span className={styles.purposeAnd}> and </span>less stressful.
                </p>
                <p className={styles.understandingText}>As parents and business owners, we get it.</p>
                <img src={family} alt="Children Playing" className={styles.image} />
            </div>
        </div>
    );
};
